...
public class ActiveChallengesRecyclerAdapter extends BaseRecyclerAdapter<Challenge> {

    private boolean deleteMode = false;
    private List<Challenge> toBeDeleted;

    public ActiveChallengesRecyclerAdapter(Context mContext) {
        super(mContext);
    ...
    public void highlightChallenge(Challenge challenge, int position) {
        ...
        ((MainActivity) context).onChallengeDeleteMode(deleteMode, true);
